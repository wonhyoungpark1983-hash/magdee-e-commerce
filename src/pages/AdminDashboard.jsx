...
const AdminDashboard = () => {
    ...
    const { products, addProduct, updateProduct, deleteProduct, toggleFeatured, toggleBestSeller } = useProducts();
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className={`fixed left-0 top-0 h-full w-64 bg-primary text-white p-6 transform transition-transform duration-300 z-40 ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}>
                ...
                <nav className="space-y-2">
                    <Link to="/admin/dashboard" className="block py-2 px-4 bg-white bg-opacity-10 rounded-lg font-medium">
                        Products
                    </Link>
                    ...
                    <Link to="/admin/dashboard/settings" className="block py-2 px-4 hover:bg-white hover:bg-opacity-10 rounded-lg transition">
                        Settings
                    </Link>
